...
// array = [-2, 3, -1, 5, 4, -3, 0] 
// pick last index in array as pivot == 0
// loop thru the array using i and j 
// check if arr[j] < or > pivot
// if arr[j] < pivot, slide arr[i] + 1 , swap with arr[j]
// after all sorted, swap arr[i + 1] with pivot 
// done partitioning
